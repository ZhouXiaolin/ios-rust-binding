...
- (id)initWithACVData:(NSData *)data
{
    ...
    ToneCurveFile* curve = [[ToneCurveFile alloc] initWithToneCurveFileData:data];
...
{
//    return [self initWithACVURL:[NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:curveFilename ofType:@"acv"]]];
    return [self initWithACVURL:[[NSBundle mainBundle] URLForResource:curveFilename withExtension:@"acv"]];
}
